    ...
    <div>
      <div className="we-provide-container">
        ...
        <p className="description">
          Explore the range of features and services that make managing your
          data seamless.
        </p>
        ...
        <div className="service-item d-flex justify-content-center">
          ...
          <div className="service-details">
            <h3>Upload Data</h3>
            <p>
              Upload photos, videos, and files effortlessly and manage them
              securely.
            </p>
          </div>
        </div>
        ...
        <div className="service-item">
          ...
          <div className="service-details">
            ...
            <p>
              Enjoy free uploads or unlock premium features with our
              subscription plans.
            </p>
          </div>
        </div>
